	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        null,
	        React.createElement('input', { className: '', type: 'text', placeholder: 'search endpoint', value: this.state.searchTerm, onChange: this.handleSearch })
	      )
	    );
	  }
	});
	...
	var Header = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'ul',
	        { className: 'nav navbar-nav flex-center' },
	        React.createElement(
	          'li',
	          { className: 'nav-item' },
	          React.createElement(
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'h4',
	        null,
	        'Access your WordPress sites data through an easy-to-use HTTP REST API.'
	      ),
	      React.createElement(
	        'p',
	        null,
